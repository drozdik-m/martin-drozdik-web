...
namespace Bonsai.RazorPages.Error.Areas.ErrorPages.Pages
{
    ...
    public class ErrorPageModel : ErrorLayoutModel
    {
        ...
        public override string OgImagePath
        {
            get
            {
                if (ErrorStatusCode == "404")
                    return PathProvider.PathTo("/Images/OG/og_404.png", StaticResources.Name);
                else if (ErrorStatusCode == "500")
                    return PathProvider.PathTo("/Images/OG/og_500.png", StaticResources.Name);
                return PathProvider.PathTo("/Images/OG/og_500.png", StaticResources.Name); ;
            }
        }
        ...
        public string IconPath 
        {
            ...
            {
                if (ErrorStatusCode == "404")
                    return PathProvider.PathTo("/Images/Icons/magnifier.svg", StaticResources.Name);
                else if (ErrorStatusCode == "500")
                    return PathProvider.PathTo("/Images/Icons/server.svg", StaticResources.Name);
                return PathProvider.PathTo("/Images/Icons/server.svg", StaticResources.Name);
            }
        }
