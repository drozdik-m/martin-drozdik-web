...
namespace Bonsai.RazorPages.Error.Areas.ErrorPages.Pages
{
    ...
    public class OfflinePageModel : ErrorLayoutModel
    {
        ...
        /// </summary>
        public string IconPath => PathProvider.CleanPathTo("/Images/Icons/offline.svg", StaticResources.Name);
        ...
        public override string OgImagePath => PathProvider.CleanPathTo("/Images/OG/og_offline.png", StaticResources.Name);
