...
using MartinDrozdik.Pages.Error;
...
namespace MartinDrozdik.Pages.Error.Areas.ErrorPages.Pages
{
    ...
    public class ErrorPageModel : ErrorLayoutModel
    {
        ...
        public override string OgImagePath
        {
            get
            {
                if (ErrorStatusCode == "404")
                    return PathProvider.PathTo("/Images/OG/og_404.png", StaticResources.Namespace);
                else if (ErrorStatusCode == "500")
                    return PathProvider.PathTo("/Images/OG/og_500.png", StaticResources.Namespace);
                return PathProvider.PathTo("/Images/OG/og_500.png", StaticResources.Namespace); ;
            }
        }
        ...
        public string IconPath 
        {
            ...
            {
                if (ErrorStatusCode == "404")
                    return PathProvider.PathTo("/Images/Icons/magnifier.svg", StaticResources.Namespace);
                else if (ErrorStatusCode == "500")
                    return PathProvider.PathTo("/Images/Icons/server.svg", StaticResources.Namespace);
                return PathProvider.PathTo("/Images/Icons/server.svg", StaticResources.Namespace);
            }
        }
