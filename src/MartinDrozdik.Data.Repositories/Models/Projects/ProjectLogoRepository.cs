...
{
    public class ProjectLogoRepository : ProjectImageRepository<ProjectLogo>
    {
        public ProjectLogoRepository(AppDb context)
            : base(context)
        {

        }

        protected override DbSet<ProjectLogo> EntitySet => Context.ProjectLogos;
    }
}
