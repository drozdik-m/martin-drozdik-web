...
{
    public class ProjectPreviewImageRepository : ProjectImageRepository<ProjectPreviewImage>
    {
        public ProjectPreviewImageRepository(AppDb context)
            : base(context)
        {

        }

        protected override DbSet<ProjectPreviewImage> EntitySet => Context.ProjectPreviewImages;
    }
}
