...
{
    public class ProjectPreviewImageController : ImageController<ProjectPreviewImage>
    {
        readonly ProjectPreviewImageFacade facade;

        public ProjectPreviewImageController(ProjectPreviewImageFacade facade)
            : base(facade)
        {
            this.facade = facade;
        }
