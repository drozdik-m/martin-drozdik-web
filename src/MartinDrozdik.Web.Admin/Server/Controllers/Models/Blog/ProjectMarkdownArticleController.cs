...
{
    public class BlogMarkdownArticleController : MarkdownArticleController<BlogMarkdownArticle>
    {
        readonly BlogMarkdownArticleFacade facade;

        public BlogMarkdownArticleController(BlogMarkdownArticleFacade facade)
            : base(facade)
        {
            this.facade = facade;
        }
