...
{
    public class ArticleMainImageService : MediaBaseService<ArticleMainImage>
    {
        public ArticleMainImageService(HttpClient http)
            : base(http)
        {

        }

        protected override string ApiUri { get; set; } = "/api/ArticleMainImage";
    }
}
