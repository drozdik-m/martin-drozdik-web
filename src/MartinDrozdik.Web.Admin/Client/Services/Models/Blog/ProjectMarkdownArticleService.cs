...
{
    public class BlogMarkdownArticleService : MarkdownArticleService<BlogMarkdownArticle>
    {
        public BlogMarkdownArticleService(HttpClient http)
            : base(http)
        {

        }

        protected override string ApiUri { get; set; } = "/api/BlogMarkdownArticle";
    }
}
