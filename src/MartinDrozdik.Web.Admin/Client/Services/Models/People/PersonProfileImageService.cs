...
{
    public class PersonProfileImageService : MediaBaseService<PersonProfileImage>
    {
        public PersonProfileImageService(HttpClient http)
            : base(http)
        {

        }

        protected override string ApiUri { get; set; } = "/api/PersonProfileImage";
    }
}
