...
{
    public class ProjectOgImageService : MediaBaseService<ProjectOgImage>
    {
        public ProjectOgImageService(HttpClient http)
            : base(http)
        {

        }

        protected override string ApiUri { get; set; } = "/api/ProjectOgImage";
    }
}
